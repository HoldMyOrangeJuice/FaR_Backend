...
public class Main {
    ...
    static HashMap<Client, SocketChannel> clients = new HashMap<>();
        ...
        while (true) {
            ...
            while (crunchifyIterator.hasNext()) {
                ...
                else if (myKey.isReadable())
                {
                    ...
                    {
                        SocketChannel receiver = Server.consumers.get(serverMessage.receiver);
                        receiver.write(ByteBuffer.wrap(serverMessage.format().getBytes()));
                    }
                }
